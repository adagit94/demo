...
function InputTemplate<T>({
    ...
    const inputClassNames = composeStrBool([[isValid === false, "input-template--invalid"], [!!readOnly, "input-template--read-only"]], "input-template")
    ...
    return (
        ...
        >
            ...
            <div className="input-template__input-container">
                <div className="input-template__input">
                    {children}
                </div>
